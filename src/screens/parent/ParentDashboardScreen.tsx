...
type ParentDashboardNavigationProp = StackNavigationProp<ParentHomeStackParamList, 'ParentDashboard'>;
...
const ParentDashboardScreen = () => {
  ...
  const handleNotificationPress = async (notification: ParentNotification) => {
    try {
      ...
      if (notification.type === 'grade' && notification.relatedStudentId && notification.relatedSubjectId) {
