...
// Add mock grades data to fix the reference error
const mockRecentGrades = [
  { id: 1, title: 'Final Exam', subject: 'Mathematics', grade: 'A+' },
  { id: 2, title: 'Research Paper', subject: 'History', grade: 'B' },
  { id: 3, title: 'Lab Report', subject: 'Physics', grade: 'A-' }
]
